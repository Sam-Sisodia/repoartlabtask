...
SECRET_KEY = 'django-insecure-x4d(ul75we&!4mu$)l7gct$5*kgx+yy_-9@8d%#q+u41nme&9$'
...
#    # ('*/ * * * *', 'mycron.email.my_first_job'),
#     ('*/5 * * * *', 'app.email.reminder_email',['email'])
#     #('* * * * *', 'mycron.email.reminder_email')
# ]